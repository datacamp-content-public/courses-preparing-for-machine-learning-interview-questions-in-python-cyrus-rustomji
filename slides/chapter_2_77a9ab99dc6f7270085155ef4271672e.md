...
`@script`
So first, a quick overview, a linear regression model is a model that summarizes and studies relationships between two continuous variables, independent or predictor variables vs. dependent or response variables.
