...
`@script`
Here is a question on which model fits best for the given dataset.
...
The correct answer is C because you’re trying to predict a number.
The other three models outputs have probabilistic outcomes, which would not work for predicting the US immigration quota.
